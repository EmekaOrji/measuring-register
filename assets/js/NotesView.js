export default class NotesView {
  ...
  setActiveProfile(card) {
    ...
    blouseLengthInput.value = card.blouse.lenth;
    blouseBurstInput.value = card.blouse.burst;
    blouseUpperBurstInput.value = card.blouse.upperBurst;
    blouseLowerBurstInput.value = card.blouse.lowerBurst;
    blouseRoundLowerBurstInput.value = card.blouse.roundLowerBurst;
    blouseWaistInput.value = card.blouse.waist;
    blouseShoulderInput.value = card.blouse.shoulder;
    blouseHipInput.value = card.blouse.hip;
    blouseThirdQuarterLengthInput.value = card.blouse.thirdQuarterLength;
    blouseHalfLengthInput.value = card.blouse.halfLength;
    blouseSleeveInput.value = card.blouse.sleeve;
    blouseRoundSleeveInput.value = card.blouse.roundSleeve;
    blouseNeckInput.value = card.blouse.neck;
    gownLengthInput.value = card.gown.lenth;
    gownBurstInput.value = card.gown.burst;
    gownUpperBurstInput.value = card.gown.upperBurst;
    gownLowerBurstInput.value = card.gown.lowerBurst;
    gownRoundLowerBurstInput.value = card.gown.roundLowerBurst;
    gownWaistInput.value = card.gown.waist;
    gownShoulderInput.value = card.gown.shoulder;
    gownHipInput.value = card.gown.hip;
    gownThirdQuarterLengthInput.value = card.gown.thirdQuarterLength;
    gownHalfLengthInput.value = card.gown.halfLength;
    gownSleeveInput.value = card.gown.sleeve;
    gownRoundSleeveInput.value = card.gown.roundSleeve;
    gownNeckInput.value = card.gown.neck;
    skirtLengthInput.value = card.skirt.lenth;
    skirtHalfLengthInput.value = card.skirt.halfLength;
    skirtWaistInput.value = card.skirt.waist;
    skirtHipInput.value = card.skirt.hip;
    trouserLengthInput.value = card.trouser.lenth;
    trouserWaistInput.value = card.trouser.waist;
    trouserThightInput.value = card.trouser.thight;
    trouserKneeInput.value = card.trouser.knee;
    trouserCalfInput.value = card.trouser.calf;
    trouserAnkleInput.value = card.trouser.ankle;
    trouserFlapInput.value = card.trouser.flap;
